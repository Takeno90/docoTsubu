...
@WebServlet( //"/CounterServlet"
		urlPatterns = { "/CounterServlet11_2_conflict" },
		initParams = {
				@WebInitParam(name = "bgcolor", value = "yellow")
		})

public class CounterServlet11_2_conflict extends HttpServlet {
	 ...
	 */
	public CounterServlet11_2_conflict() {
		super();
	...
	public void init(ServletConfig config) throws ServletException {
		 ...
		 * =>パラメータなしのinitメソッド
		 */
		super.init(config); //①．制約あり!(記述必須:p.315)
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//★訪問回数を増加(リスト11-2)
		synchronized(count) {		//★スレッドの排他制御
			count++;
		}


		//HTMLを出力(リスト11-1、11-2共通)
		...
		out.println("<a href=\"/docoTsubu/CounterServlet11_2_conflict\">更新</a>");
		out.println("</body>");
		out.println("</html>");
	}
